...
class Cell:
    ...
    def __sub__(self, other):
        return Cell(self.count - other.count) if self.count > other.count else 'Subtraction is not allowed!'

    def __mul__(self, other):
        return Cell(self.count * other.count)

    def __truediv__(self, other):
        return Cell(self.count // other.count) if other.count > 0 else 'Division is not allowed!'

    def make_order(self, cell_per_row):
        if cell_per_row > 0:
            full_lines = self.count // cell_per_row
            ending = self.count % cell_per_row
        else:
            print('Cells per row must be greater than 0!')
            return
...
print('cell_1 * cell_2 =', cell_1 * cell_2)
print('cell_1 / cell_2 =', (cell_1 / cell_2).count)
